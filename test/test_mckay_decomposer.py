...
def are_matrices_equal_up_to_global_phase(matrix_a, matrix_b):
    first_non_zero = next(
...
class DecomposeMcKayTests(unittest.TestCase):
    def checkMcKayDecomposition(self, squirrel_ir, expected_ir=None):
        """
        ...
        self.assertTrue(are_matrices_equal_up_to_global_phase(actual_matrix, expected_matrix))
    ...
    def test_one(self):
        ...
        self.checkMcKayDecomposition(ir)
    ...
    def test_small_random(self):
        ...
        self.checkMcKayDecomposition(ir, expected_ir)
