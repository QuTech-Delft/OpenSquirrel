...
from opensquirrel.parser.libqasm.libqasm_parser import LibqasmIRCreator
...
CRk my_qubits[0], my_qubits[1], 23
        ...
        self.assertEqual(ir.qubit_register_size, 2)
...
CRk q[0, 3], q[1, 4], 23
        ...
        self.assertEqual(ir.qubit_register_size, 20)
