...
def type_check_antlr_tree(tree, gate_set, gate_aliases, measurement_set):
    type_checker = TypeChecker(gate_set, gate_aliases, measurement_set)
...
def squirrel_ir_from_string(s: str, gate_set, gate_aliases, measurement_set):
    """
