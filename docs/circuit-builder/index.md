...
Quantum circuits can be constructed using Python functionalities, via the `CircuitBuilder` object, as shown below.
...
- [Unitary Gates](instructions/gates.md)
- [Non-Unitary Gates](instructions/non-unitaries.md)
- [Control Gates](instructions/control-instructions.md)